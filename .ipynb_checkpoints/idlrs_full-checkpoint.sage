 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "#=========================================\n",
    "\n",
    "def output_avg_time_and_size(public_parameters_list, ring_of_signers_list, event, message, message_2, number_of_runs): \n",
    "    \"\"\"\n",
    "    \"\"\"\n",
    "    \n",
    "    \n",
    ...
    "        print(i, \"/ We are doing on the \",i, \"-th public parameters (n, q, mt, w, m, M, sigma_1, sigma_2, sigma_3, sigma)=\", public_parameters)\n",
    "        \n",
    ...
    "                print(\"              ----------------- public key size=\",size_public_key, \"bytes\")\n",
    ...
    "                print(\"              ----------------- secret key size=\",size_secret_key, \"bytes\")\n",
    "\n",
    "                print(\"         ------------------Keygen done\", \", runtime=\", cputime(t1), \" sec\")\n",
    "\n",
    "                \n",
    ...
    "\n",
    "                     # Private key size\n",
    "                size_private_key = idlrs_get_private_key_size(private_key_real_signer) \n",
    "                size_private_key_list.append(size_private_key)\n",
    "                print(\"            ----------------- private key size=\",size_private_key , \"bytes\")\n",
    "                print(\"         ------------------extract done,\",  \"runtime=\", cputime(t2), \" sec\")\n",
    "                \n",
    "                # for Sign\n",
    "                print(\"        ------------------Sign starts\")\n",
    "                t3 = cputime()\n",
    ...
    "                print(\"          ------------------Sign done,\",  \"runtime=\", cputime(t3) , \" sec\")\n",
    "                \n",
    "                \n",
    "                # for Verify\n",
    "                print(\"        ------------------Verify starts\")\n",
    ...
    "                \n",
    "                print(\"        ------------------Verify done,\",  \"runtime=\", cputime(t4),  \" sec\")\n",
    "                \n",
    ...
    "                print(\"        ------------------Link done,\",  \"runtime=\", cputime(t5) , \" sec\")\n",
    "                \n",
    "                print(\"     -------done for the \",j, \"-th run\")\n",
    "\n",
    ...
    "            g_time_info = str(i) + ',' +  str(number_of_signers)+ ',' +  str(avg_keygen_time) + ',' +  str(avg_extract_time) + ',' + str(avg_sign_time) + ','+ str(avg_verify_time) + ','+ str(avg_link_time) +'\\n'\n",
    ...
    "            f_size_info = str(i) + ',' + str(number_of_signers) + ',' + str(avg_size_public_key) + ',' +  str(avg_size_secret_key) + ',' + str(avg_size_private_key) + ','+ str(avg_size_signature) + '\\n'\n",
    ...
    "        print(\"done for the \", i,\"-th public parameters./.\")\n",
    ...
    "\n",
    "#===========================================================\n",
    "def draw_graph(graph_title, x_label, y_label, x_list,  y1_list, y1_legend, y2_list, y2_legend, y3_list, y3_legend):\n",
    ...
    "    \n",
    "    plt.plot(x_list, y1_list, label = y1_legend) \n",
    "    plt.plot(x_list, y2_list, label = y2_legend) \n",
    "    plt.plot(x_list, y3_list, label = y3_legend) \n",
    "    \n",
    "    # naming the x axis \n",
    "    plt.xlabel(x_label) \n",
    "    # naming the y axis \n",
    ...
    "\n",
    "#public_parameters_0=(10,256,80,5,160,3,4.48083023712027,134.399270642405,3063.21047563438,2.84730315793441e6)\n",
    "public_parameters_1=(10,1024,100,5,200,3,4.48083023712027,149.781905985861,3816.75451687774,1.14108924246418e7) #ok\n",
    "public_parameters_2=(15,65536,240,8,480,3,4.48083023712027,249.216051813832,9838.21749142210,2.53427593976609e7)\n",
    "public_parameters_3=(20,262144,360,10,720,3,4.48083023712027,319.984630547929,15470.8846033889,6.10110178692153e7)\n",
    "public_parameters_4=(40,524288,760,20,1520,3,4.48083023712027,513.581058139720,36078.6738903173,4.13455935936785e8)\n",
    "public_parameters_list=[public_parameters_1]#,public_parameters_1, public_parameters_2, public_parameters_3 ]\n",
    "number_of_runs=5\n",
    "\n",
    "    \n",
    "#========================== RUNNNN===\n",
    "\n",
    "output_avg_time_and_size(public_parameters_list, ring_of_signers_list, event, message, message_2, number_of_runs)\n"
   ]
  }
 ],
 "metadata": {
